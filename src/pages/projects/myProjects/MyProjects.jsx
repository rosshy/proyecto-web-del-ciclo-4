...
import { Add_Advance, Update_Advance } from '../../../graphql/projects/Mutations';
...
export default function MyProjects() {
    ...
    const [updateAdvance, { data : dataUpAdv, error : errorUpAdv }] = useMutation(Update_Advance);
    ...
    useEffect(() => { 
        getProjects();     
        if (error || errorAdvances || errorAddAdv || errorUpAdv ) { 
            Swal.fire({
                icon: 'error',
    ...
    }, [data, error, dataAdvances, errorAdvances, errorAddAdv, errorUpAdv, getProjects]); 
    ...
    return (
        <div className="bodyLider">
            <div className="container">
                ...
                <h2 id="titleLogo">Gestion de Proyectos - Estudiante</h2> <br />
                <hr className="hrProject" />
            </div>
            <div id="containMain" className="container border mt-5">
                <div className="container mt-4">
                    <h4 className='m-5'>
                        { <i className="fab fa-buffer iconArray" /> }Proyectos Registrados en la Plataforma
                    </h4> 
                    <div className=" row g-3">
                        <div id="divCards" className="card-group row g-3">
                        { 
                            data && data.allProjects.map( project => 
                                project.Inscripciones.map(element => {
                                                ...
                                                <div className="card text-dark">
                                                    ...
                                                    <div className="card-footer btnCard">                                                                                  
                                                        <section className="mt-1">
                                                            <button type="button" className="btn btn-secondary btn-sm btn2 mb-1 btnColor" 
                                                                data-bs-toggle="modal" data-bs-target="#modalEditProjectStudent" onClick={ () => {
                                                                    setIdProject(project._id); setNameProject(project.Nombre); 
                                                                    setObjGener(project.Ob_Generales);
